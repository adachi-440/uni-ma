export default class MainRegistrationsForm {
  constructor() {
  }

  run() {
    MainRegistrationsForm.onSelectedUniversity()
    MainRegistrationsForm.onSelectedDepartment()
    MainRegistrationsForm.onLoadPage()
